#
#  Be sure to run `pod spec lint Composer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "sergey.bayborodov"
  # s.authors            = { "sergey.bayborodov" => "sergey.bayborodov@piano.io" }
  # s.social_media_url   = "http://twitter.com/sergey.bayborodov"
  ...
  s.ios.vendored_frameworks = 'Composer.framework'
end
