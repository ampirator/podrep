...
* Understand how people navigate to articles, how much time they spend there, and where they go next.
  ...
  s.source = { http: "https://s3.amazonaws.com/sdk.cxense.com/CxenseSDK-tvOS-1.9.1.zip", type: :zip }

  s.tvos.deployment_target = '9.0'

  s.preserve_paths = 'CxenseSDK_TV.xcframework'
  s.vendored_frameworks = 'CxenseSDK_TV.xcframework'
